                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="" class="mb-4">
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <input type="text" class="w-100 form-control border-0 py-3" id="contactName" placeholder="Your Name" <?php if(isset($_SESSION['user'])):?>value="<?=$_SESSION['user']->name?>"<?php endif?> />
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="email" class="w-100 form-control border-0 py-3" id="contactEmail" placeholder="Enter Your Email" <?php if(isset($_SESSION['user'])):?>value="<?=$_SESSION['user']->email?>"<?php endif?> >
                                    </div>
                                    <div class="col-12">
                                        <textarea id="contactMessage" class="w-100 form-control border-0" rows="6" cols="10" placeholder="Your Message"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button class="w-100 btn btn-primary form-control py-3" id="btnContactMessage" type="button">Submit Now</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row g-4">
